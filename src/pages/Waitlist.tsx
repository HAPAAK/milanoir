        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            delay: 0.1
              ...
              {/* Countdown section */}
              <div className="mb-8">
              <p className="text-sm text-muted-foreground uppercase tracking-widest mb-4 flex items-center gap-2">CELEBRATIONS BEGINS IN...
I BEGINS IN...<Clock className="w-4 h-4 text-secondary" />
                Infinity begins in...
              </p>
                <CountdownTimer />
              </div>
